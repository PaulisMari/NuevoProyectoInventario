                    ...
                    <tbody>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <form action="index3.php?action=eliminarEmpleado" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro que deseas eliminar este empleado?');">
                                        <input type="hidden" name="DocEmpleado" value="<?= htmlspecialchars($user['DocEmpleado']) ?>" />
